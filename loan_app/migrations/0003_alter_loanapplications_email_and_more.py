# Generated by Django 4.2.21 on 2025-06-09 17:06
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('loan_app', '0002_alter_loanapplications_loan_amount'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='loanapplications',
            name='purpose',
            field=models.CharField(choices=[('business', 'Business Expenses'), ('debt', 'Debt Consolidation'), ('education', 'Education Cost'), ('emergencey', 'Emergencey Expenses'), ('home', 'Home Improvements'), ('one', 'One of Purchases'), ('personal', 'Personal Expenses'), ('travel', 'Travel Expenses'), ('vehicle', 'Vehicle Expenses'), ('weddinge_event', 'Weddings or Events')], max_length=50),
        ),
        migrations.AlterField(
            model_name='loanapplications',
            name='title',
            field=models.CharField(choices=[('mr', 'Mr'), ('mrs', 'Mrs'), ('miss', 'Miss'), ('ms', 'Ms'), ('dr', 'Dr.')], max_length=30),
        ),
    ]
